...
force force force kat_airway_Suction_reuse = true;
...
force kat_circulation_blood_draw_limit = 4.6;
...
force kat_circulation_CPR_MaxChance_Doctor = 60;
force kat_circulation_CPR_MaxChance_RegularMedic = 45;
