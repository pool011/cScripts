...
// kat_pharma_chromatic_aberration_slider_fentanyl = 1.0;
// kat_pharma_chromatic_aberration_slider_ketamine = 0.6;
// kat_pharma_chromatic_aberration_slider_pervitin = 8.0;
